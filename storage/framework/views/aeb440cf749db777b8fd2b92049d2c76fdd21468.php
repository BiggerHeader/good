                    ...
                    <div class="row row-rl-10">
                        ...
                        <div class="col-sm-5 col-md-6">
                            <div class="store-about ptb-30">
                                <h3 class="mb-10"><?php echo e($category->name); ?></h3>
                                <p class="mb-15">
                                ...
                                <div class="left-splitter-header prl-10 ptb-20 bg-lighter">
                                    <div class="row">
                                        <div class="col-xs-12 t-center">
                                            <h2><?php echo e($category->products()->count()); ?></h2>
                                            <p>商品</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <section class="section deals-area ptb-30">
                    ...
                    <header class="page-control panel ptb-15 prl-20 pos-r mb-30">
                        ...
                        <ul class="list-control-view list-inline">
                            <li><a href="<?php echo e(url('/home/categories')); ?>"><i class="fa fa-reply"></i></a>
                            </li>
                        </ul>
                        <!-- End List Control View -->
                        <div class="right-10 pos-tb-center">
                            <form id="order-form" action="<?php echo e(url()->current()); ?>" method="get">
                            ...
                            <div class="col-xs-12">
                                <div class="deal-single panel">
                                    <div class="row row-rl-0 row-sm-cell">
                                        <div class="col-sm-5">
                                            <a href="<?php echo e(url("/home/products/{$product->id}")); ?>">
                                                <figure class="deal-thumbnail embed-responsive embed-responsive-16by9 col-absolute-cell" data-bg-img="<?php echo e($productPresenter->getThumbLink($product->thumb)); ?>">
                                                    <div class="label-discount left-20 top-15">-50%</div>
                                                    <ul class="deal-actions top-15 right-20">
                                                        <li  class="like-deal" data-id="<?php echo e($product->id); ?>">
                                                            <span>
                                            ...
                                            <div class="bg-white pt-20 pl-20 pr-15">
                                                <div class="pr-md-10">
                                                    <div class="rating mb-10">
                                                        <div class="mb-10">
                                                            收藏人数 <span class="rating-count rating"><?php echo e($product->users->count()); ?></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="deal-price pos-r mb-15">
                                                    <h3 class="price ptb-5 text-right">
                                                                <span class="price-sale">
                                                                    <?php echo e($product->price_original); ?>
                    ...
                    <div class="page-pagination text-center mt-30 p-10 panel">
                        <nav>
                            <?php echo e($categoryProducts->appends(request()->only('orderBy'))->links()); ?>
