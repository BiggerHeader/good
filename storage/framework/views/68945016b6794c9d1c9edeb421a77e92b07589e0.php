...
<?php $__env->startSection('style'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin/lib/zTree/v3/css/zTreeStyle/zTreeStyle.css')); ?>"
          type="text/css">
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript"
            src="<?php echo e(asset('assets/admin/lib/datatables/1.10.0/jquery.dataTables.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/admin/lib/laypage/1.2/laypage.js')); ?>"></script>
    <script type="text/javascript">
        // 数据表格排序
        ...
        function product_stop(id, status, table) {
            ...
            layer.confirm('确认要修改吗？', function (index) {
                layer.close(index);
                var url = "<?php echo e(url('/admin/products/change/alive')); ?>/" + id;
                $.post(url, {is_alive: status, _token: '<?php echo e(csrf_token()); ?>'}, function (res) {
