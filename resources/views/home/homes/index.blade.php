                                    ...
                                    <div class="deal-single panel item">
                                        <a href="{{ url("/home/products/{$hotProduct->id}") }}">
                                            <figure class="deal-thumbnail embed-responsive embed-responsive-16by9"
                                                    data-bg-img="{{ $productPresenter->getThumbLink($hotProduct->thumb) }}">
                                        ...
                                        <div class="deal-about p-20 pos-a bottom-0 left-0">
                                            <div class="mb-10">
                                                收藏人数 <span
                                                        class="rating-count rating">{{ $hotProduct->users->count() }}</span>
                                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="deal-single panel">
                                    <a href="{{ url("/home/products/$latestProduct->id") }}">
                                        <figure class="deal-thumbnail embed-responsive embed-responsive-16by9"
                                                data-bg-img="{{ $productPresenter->getThumbLink($latestProduct->thumb) }}">
                                    ...
                                    <div class="bg-white pt-20 pl-20 pr-15">
                                        <div class="pr-md-10">
                                            <div class="mb-10">
                                                收藏人数 <span
                                                        class="rating-count rating">{{ $latestProduct->users->count() }}</span>
                                            </div>
                                            <h3 class="deal-title mb-10">
                                                <a href="{{ url("/home/products/$latestProduct->id") }}">
                                                    {{ $latestProduct->name }}
                                    ...
                                    <div class="embed-responsive embed-responsive-4by3">
                                        <div class="store-logo">
                                            <img class="user-avatar"
                                                 src="{{ $userPresenter->getThumbLink($user->avatar) }}"
                                                 alt="{{ $user->name }}">
                                        </div>
                                    </div>
