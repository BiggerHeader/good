    ...
    <div class="paycont">
        ...
        <div class="logistics">
            ...
            <ul class="pay-list" id="pay-list">
                <li data-id="1" class="pay taobao selected"><img
                            src="{{ asset('images/zhifubao.jpg') }}"/>支付宝<span></span></li>
                ...
                <form id="post_form">
                    ...
                    <div id="holyshit269" class="submitOrder">
                        <div class="go-btn-wrap">
                            <button id="J_Go" type="button" id="pay_btn" class="btn-go" tabindex="0" title="点击此按钮，提交订单">
                                提交订单
                            </button>
                        </div>
                    </div>
